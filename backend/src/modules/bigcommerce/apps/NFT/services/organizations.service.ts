...
class OrganizationsService {
  ...
  // public async findOrganizationsByUserAccount(account: string): Promise<Organizations> {
  //   const org: Organizations = await this.db.organizationsModel.findOne({ account: account });
  //   return org;
  // }

  // public async findOrganizationsByApps(apps: string): Promise<Organizations> {
  //   const org: Organizations = await this.db.organizationsModel.findOne({ apps: apps });
  //   return org;
  // }
